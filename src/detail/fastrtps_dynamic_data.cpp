...
FASTDDS_DYNAMIC_DATA_GET_VALUE_FN(float128, long double, float128)
...
FASTDDS_DYNAMIC_DATA_SET_VALUE_FN(float128, long double, float128)
...
FASTDDS_DYNAMIC_DATA_INSERT_VALUE_FN(float128, long double, float128)
